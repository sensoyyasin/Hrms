...
-- Started on 2021-05-10 23:32:03
...
--
-- TOC entry 3016 (class 0 OID 16619)
-- Dependencies: 200
...
--
-- TOC entry 3017 (class 0 OID 16622)
-- Dependencies: 201
...
--
-- TOC entry 3018 (class 0 OID 16625)
-- Dependencies: 202
...
--
-- TOC entry 3019 (class 0 OID 16628)
-- Dependencies: 203
...
--
-- TOC entry 3020 (class 0 OID 16631)
-- Dependencies: 204
...
--
-- TOC entry 3021 (class 0 OID 16846)
-- Dependencies: 205
...
--
-- TOC entry 2884 (class 2606 OID 16863)
-- Name: SystemPersonnel contraints_key; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SystemPersonnel"
    ADD CONSTRAINT contraints_key FOREIGN KEY (id) REFERENCES public."Users"(id) NOT VALID;


--
-- TOC entry 2882 (class 2606 OID 16853)
-- Name: Employers employers_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Employers"
    ADD CONSTRAINT employers_id FOREIGN KEY (id) REFERENCES public."Users"(id) NOT VALID;


--
-- TOC entry 2885 (class 2606 OID 16868)
-- Name: job_positions job_positions_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.job_positions
    ADD CONSTRAINT job_positions_id FOREIGN KEY (id) REFERENCES public."Users"(id) NOT VALID;


--
-- TOC entry 2883 (class 2606 OID 16858)
-- Name: JobSeekers jobseekers_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."JobSeekers"
    ADD CONSTRAINT jobseekers_id FOREIGN KEY (id) REFERENCES public."Users"(id) NOT VALID;


-- Completed on 2021-05-10 23:32:04
